...
require (
	...
	github.com/oam-dev/kubevela v1.6.7
...
require (
	...
	github.com/kubevela/workflow v0.3.4-0.20230103040208-bca032d481ed // indirect
...
replace (
	...
	k8s.io/kubectl => k8s.io/kubectl v0.0.0-20220326094706-a2a55cf23fb5
